...
STRUCTURE_PROMPT = """На основе темы, ответов интервью и материалов предложи структуру обучающего курса.
...
Предложи структуру курса в виде нумерованного списка модулей/блоков (5-8 пунктов).
Для каждого пункта — одна строка с названием и кратким описанием (1 предложение).
Учитывай цели, целевую аудиторию и содержание из интервью.
Формат: просто нумерованный список, без лишних заголовков и вводных слов."""
